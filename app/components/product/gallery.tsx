...
export function Gallery({ images, blurDataURL }: { images: { src: string; altText: string }[]; blurDataURL?: string }) {
      ...
      {images.length > 1 ? (
        <ul className='my-12 flex items-center justify-center gap-2 overflow-auto py-1 lg:mb-0'>
          {images.map((image, index) => {
            ...
            return (
              <li key={index} className='h-20 w-20' onClick={() => setIdxImage(index)}>
